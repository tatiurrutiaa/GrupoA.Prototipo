...
namespace GrupoA.Prototipo.Forms.OrdenEntrega.Model
{
    internal class OrdenEntregaModel
    {
        ...
        {
            listBox.Items.Clear();
            foreach (var orden in OrdenPreparacionArchivo.OrdenesPreparacion.Where(o => o.Estado == EstadosOrdenPreparacion.Preparada))
            {
